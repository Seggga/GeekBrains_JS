...
let buttonsCol = document.querySelectorAll("button");
let divProductsEl = document.querySelector(".products");

buttonsCol.forEach(function(button){
...
function showCategory(category) {
    for ( let i = 0; i < products[category].length; i++ ){
        divProductsEl.insertAdjacentHTML( "beforeend", getProductMarkup(products[category][i]) );
    }
}
...
function getProductMarkup(product) {
    let productMarkupStr = `<div class="product">
