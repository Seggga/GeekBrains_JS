...
buttonsCol.forEach(button => button.addEventListener("click", handleClick));
...
function handleClick(clickedButtonEvent) {
    ...
    let buttonText = clickedButtonEvent.target.innerHTML;
...
function showMoreText(card) {
    ...
    let someText = "logem imsum dolor set amet."    
